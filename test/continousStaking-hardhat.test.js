...
contract("stableStaking", (accounts) => {
   ...
   before(async () => {
      ...
      StableStaking = await hre.ethers.getContractFactory("lunaStableCoinFund");
   ...
   it("Should allow any user to stake LunaTokens", async () => {
      ...
      assert(stakeDetails1.lunaAmount == stakeAmount1)
      ...
      assert(stakeDetails2.lunaAmount == stakeAmount2)
      ...
      assert(stakeDetails3.lunaAmount == stakeAmount3)
      ...
      assert(stakeDetails4.lunaAmount == stakeAmount4)
      ...
      assert(stakeDetails5.lunaAmount == stakeAmount4)
