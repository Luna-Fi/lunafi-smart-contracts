...
| HousePool       | contracts/HousePool.sol          | Generic HousePool contract, where user can deposit approved tokens and mint a proportionate amount of liquiduty pool tokens. Also users can withdraw their approved tokens by buring the proportionate amount of liquidity pool tokens. |
| LFiFarms        | contracts/LFiFarms.sol           | An Yield farming contract, where users can deposit their liquidity pools earned from housePools and earn rewards that are distributed in "LFI". |
